...
class ScrapingScheduler:
    ...
    def update_job_status(self, job_id: int, status: str, error_message: str = None, 
                         execution_time: int = None, contacts_count: int = None):
    ...
    def execute_spider(self, job: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            spider_args = {
                'url': job['url'],
                'query_id': job_id,
                'custom_keywords': json.dumps(job['custom_keywords']) if job['custom_keywords'] else '[]',
            ...
            keywords_count = len(job['custom_keywords']) if job['custom_keywords'] else 0
    ...
    def process_jobs(self):
        ...
        try:
            ...
            if scheduler_status and scheduler_status['value'].lower() == 'true':
        ...
        try:
            ...
            if result['success']:
                ...
                should_retry = (
                    ...
                    'timeout' not in result.get('error', '').lower()
                )
    ...
    def _log_stats(self):
        ...
        logger.info(f"Stats: {stats['pending_jobs']} en attente, "
